        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Horizontal Form -->
              <form action="{{ route('roomCategory.update',$roomCategory->id) }}" method="POST">
                @csrf
                @method('patch')
                <div class="row mb-3">
                  <label for="name" class="col-sm-2 col-form-label">Room Category Name:</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="roomCategoryName" value="{{ $roomCategory->name }}">
