            ...
            <div class="card-body">
              ...
              <form action="{{ route('patient.store') }}" method="POST">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="birth_date" cols="30" class="form-control" id="birth_date" value="{{ old('birth_date') }}">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <textarea type="text" name="patientAddress" cols="30" class="form-control" id="address"></textarea>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="problem" class="col-sm-2 col-form-label">Problem:</label>
                  <div class="col-sm-10">
                    <textarea type="text" name="patientProblem" value="{{ old('patientProblem') }}" cols="30" class="form-control" id="problem"></textarea>
