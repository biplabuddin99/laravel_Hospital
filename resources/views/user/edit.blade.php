                    ...
                    <div class="box box-info">
                        <div class="panel panel-default">
                            ...
                            <div class="col-8 offset-2">
                                ...
                                <form class="form-horizontal" action="{{route('userDetails.update',$user)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('patch')
                                    <div class="form-group mt-3">
                                        <label class="control-label col-sm-3" for="name">Name <span style="color:red">* </span>:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="name" name="FullName" value="{{ old('FullName',$user->name)}}">
                                    </div>
                                    </div>
                                    <div class="form-group mt-3">
                                        <label class="control-label col-sm-3" for="userEmailAddress">Emaill <span style="color:red">* </span>:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="userEmailAddress" name="userEmailAddress" value="{{old('userEmailAddress',$user->email)}}">
                                    </div>
                                    </div>
                                    <div class="form-group mt-3">
                                        <label class="control-label col-sm-3" for="add">Address <span style="color:red">* </span>:</label>
                                    <div class="col-sm-9">
                                        <textarea name="FullAddress" id="add" cols="30" class="form-control" rows="3">{{ old('present_add',$user->address)}}</textarea>
                                    </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-3">
										...
										<div class="col-md-offset-3 col-md-9">
											<img src="{{ asset('uploads/useredit/'.$user->profile_pic) }}" alt="no image" width="150" height="200" style="margin-bottom:20px;" id="img"/>
										</div>
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="date" class="form-control" name="birthdate" value="{{ old('birthdate',$user->birth_date)}}">
                                        </div>
                                    </div>
                                    </div>
