...
<script>
    ...
    $('#room_cat_id').on('change', function(){
      ...
      //         if(data){
      //           $(v).parent('td').siblings('td').find('select').append("<option value=''> -- Room No -- </option>");
      //           for(var i in data)
      //           $(v).parent('td').siblings('td').find('select').append("<option value='"+data[i].id+"'>"+data[i].room_no+"</option>");
      //         }
      //       }
      //     });
      //   }
