        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Horizontal Form -->
                 <form action="{{ route('roomList.update',$roomList->id) }}" method="POST">
                @csrf
                @csrf
                @method('patch')
                ...
                <div class="col-sm-10">
                    <select class="form-control" id="room_cat_name" name="room_cat_name" required>
                        ...
                        @forelse($bl as $b)
                            <option value="{{$b->id}}" {{$b->id ==$roomList->id?'selected' : ''}}>{{$b->name}}</option>
                        @empty
                ...
                <div class="form-group mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="roomno" name="roomListNo" value="{{ $roomList->room_no }}">
                ...
                <div class="form-group mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="floorno" name="roomfloorNo" value="{{ $roomList->floor_no }}">
                ...
                <div class="form-group mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="des" name="rmdescripton" value="{{ $roomList->description }}">
                ...
                <div class="form-group mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="capc" name="Capacity" value="{{ $roomList->capacity }}">
                ...
                <div class="form-group mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="prc" name="roomPrice" value="{{ $roomList->price }}">
