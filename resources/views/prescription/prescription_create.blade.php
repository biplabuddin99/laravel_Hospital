											...
											<div class="row p2">
												<div class="col-md-6">
													 <div class="form-group row">
														...
														<div class="col-md-10">
															<input type="text" class="form-control" id="name" name="name" value="{{$data->patient->first_name .' '. $data->patient->last_name}}">
														</div>
													</div>
												</div>
												<div class="col-md-3">
													<div class="form-group row">
														...
														<div class="col-md-10">
															<input type="text" class="form-control" id="age" name="age" value="{{\Carbon\Carbon::parse($data->patient->birth_date)->diff(\Carbon\Carbon::now())->format('%y years')}}">
														</div>
													</div>
												</div>
												<div class="col-md-3">
											...
											<div class="row p3">
												<div class="col-md-12">
													<div class="form-group row">
														...
														<div class="col-md-11">
															<textarea class="form-control" rows="1" id="address" name="address">{{$data->patient->present_address}}</textarea>
														</div>
													</div>
												</div>
											</div>
