    ...
    <section class="section">
      ...
      @endif
        ...
        <div class="row">
          <!-- left column -->
            <div class="col-md-12">
              <div class="title">Add New Shift</div>
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    ...
                    @method('POST')
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="ShiftName" name="ShiftName" value="{{old('ShiftName')}}">
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-3" style="float:left">
                              ...
                              <input type="time" class="" name="start_time" id="start_time">
                            ...
                            <div class="col-3">
                              ...
                              <input type="time" class="" name="end_time" id="end_time">
